...
// Terrible hash function, tons of collisions
...
//typedef ds_hashset<std::string, TerribleHashFunction> ds_hashset_type;
//typedef ds_hashset<std::string, AnagramHashFunction> ds_hashset_type;
