...
// ====================================================================
template <> bool Image<Color>::Save(const std::string &filename) const
{
...
template <> bool Image<Color>::Load(const std::string &filename)
{
    int len = filename.length();
    if (!(len > 4 && filename.substr(len-4) == std::string(".ppm"))) {
        std::cerr << "ERROR: This is not a PPM filename: " << filename << std::endl;
...
// ====================================================================
template <> bool Image<bool>::Save(const std::string &filename) const
{
    int len = filename.length();
...
template <> bool Image<bool>::Load(const std::string &filename)
{
    int len = filename.length();
    if (!(len > 4 && filename.substr(len-4) == std::string(".pbm"))) {
        std::cerr << "ERROR: This is not a PBM filename: " << filename << std::endl;
...
// ====================================================================
template <> bool Image<Offset>::Save(const std::string &filename) const
{
    int len = filename.length();
...
template <> bool Image<Offset>::Load(const std::string &filename)
{
    int len = filename.length();
    if (!(len > 7 && filename.substr(len-7) == std::string(".offset"))) {
        std::cerr << "ERROR: This is not a OFFSET filename: " << filename << std::endl;
